				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='product_images/$pro_image' style='width:285px; height:200px;'/>
								</div>
			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.bkash.com/notice" method="post">
							<input type="hidden" name="cmd" value="_cart">
							<input type="hidden" name="business" value="shoppingcart@ReinMart.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/ReinMart_ECOM/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/ReinMart_ECOM/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/ReinMart_ECOM/cancel.php"/>
									<input type="hidden" name="currency_code" value="Taka"/>
									<input type="hidden" name="custom" value="'.$_SESSION["uid"].'"/>
									<input style="float:right;margin-right:80px;" type="image" name="submit"
										src="product_images/bkash.gif" alt="BKash Payment"
									>
								</form>';
				}
			}
